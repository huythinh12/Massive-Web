...
function scrollFunction() {
    ...
    if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
        document.getElementById("collapsibleNavbar").style.height = "60px";
        document.getElementById("collapsibleNavbar").style.backgroundColor = "black";
        document.getElementById("collapsibleNavbar").style.transition = "all 0.3s";
    } else {
        document.getElementById("collapsibleNavbar").style.height = "100px";
        document.getElementById("collapsibleNavbar").style.backgroundColor = "";
    }
